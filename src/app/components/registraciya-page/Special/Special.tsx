                    ...
                    <div className={styles.specialText}>
                        <div className={styles.textCon}>
                            ...
                            <p className={styles.text}>
                                ...
                                чтобы начало церемонии было ярким и запоминающимся.
                            </p>
                        </div>
                        <div className={styles.textCon}>
                            <div className={styles.textTitleCon}>
                            ...
                            <p className={styles.text}>
                                Эстетика важна для вашей свадьбы. Мы подготовим стильную зону для регистрации 
                                и обеспечим безупречное оформление пространства в соответствии с тематикой торжества.
                            </p>
                        </div>
                        <div className={styles.textCon}>
                            <div className={styles.textTitleCon}>
