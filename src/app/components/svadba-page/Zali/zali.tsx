    ...
    >
      ...
      <div className={styles.grid}>
        <Card
          image="/zali/zal1.jpg"
          title="Колонный"
          desc="Просторный светлый зал с величественными колоннами для масштабных торжеств."
          people="200"
        ...
        <Card
          image="/zali/zal2.jpg"
          title="Основной"
          desc="Классический интерьер в теплых тонах, создающий атмосферу гостеприимства."
          people="80"
        ...
        <Card
          image="/zali/zal3.jpg"
          title="Каминный"
          desc="Камерный зал с настоящим камином для самых близких и душевных событий."
          people="60"
